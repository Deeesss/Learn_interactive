...
define gui.dev_notes = _p("""This first litle serious renpy novel, i try something learn in programming like python and after end this journey i
i want go to the C++ """)
...
Sprites - Deeesss
\n
Backgrounds - Army style
\n\n
{size=+75}Soundtrack{/size}
\n
Peter Dudas
\n\n
{size=+75}Visual novel learning{/size}
\n
