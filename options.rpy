...
define config.name = _("No pressure")
...
define gui.about = _p(""" Just for learn something
)
""")
...
define build.name = "Learn_interactive_Welcome"
...
define config.main_menu_music = Game2
